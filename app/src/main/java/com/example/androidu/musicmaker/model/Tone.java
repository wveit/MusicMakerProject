...
public class Tone {
    ...
    public Instrument getInstrument(){ return mInstrument; }
    public int getStartMeasure(){ return mMeasure; }
    public int getStartBeat(){ return mBeat; }
    public int getLengthInBeats(){ return mLengthInBeats; }
